		...
		while(true) {
			...
			case 2:
				...
				for (BookBean bean : books) {
					System.out.println(bean.getBookId() + " " + bean.getName() + " " + bean.getAuthor() + " " + bean.getPrice()+" "+bean.getQuantity());
				}
			...
			case 4:
				...
				System.out.println(
						book.getBookId() + " " + book.getName() + " " + book.getAuthor() + " " + book.getPrice()+" "+book.getQuantity());
				break;
